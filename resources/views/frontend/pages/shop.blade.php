                    ...
                    <ul class="list-unstyled">
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/300X300/img1.jpg')  }}" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/300X300/img3.jpg')  }}" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                                    <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="../shop/single-product-fullwidth.html">Notebook Black Spire V Nitro VN7-591G</a></h3>
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/300X300/img5.jpg')  }}" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/300X300/img6.jpg')  }}" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="{{ asset('frontend/assets/img/300X300/img10.png')  }}" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                                ...
                                <div class="product-item__outer h-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img class="img-fluid" src="{{ asset('frontend/assets/img/212X200/img9.jpg')  }}" alt="Image Description"></a>
                                            </div>
                                ...
                                <div class="product-item__outer h-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <div class="mb-2">
                                                <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img class="img-fluid" src="{{ asset('frontend/assets/img/212X200/img10.jpg')  }}" alt="Image Description"></a>
                                            </div>
                                            <div class="flex-center-between mb-1">
